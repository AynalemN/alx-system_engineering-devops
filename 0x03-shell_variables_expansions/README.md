0. <o>- a script that creats an alias.
...
13. Floats-a script that prints a number with two decimal places, followed by a new lin-a. The number will be stored in the environment variable NUM.
